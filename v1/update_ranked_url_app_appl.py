...
def update_ranked_url_app_appl(passkey):
  ranked_url_data = get_all_top_300_url(passkey)
  
  for url_dict in ranked_url_data:
    url = url_dict["url_to"]
...
if __name__ == "__main__":
  ...
  print(len(passkey) * "*")
  time.sleep(3)
  result = update_ranked_url_app_appl(passkey)
  print(result)
